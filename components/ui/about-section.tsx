...
const AboutSection: React.FC = () => {
  ...
  return (
    <div 
      ref={sectionRef} 
      className="w-full pt-20 sm:pt-24 md:pt-28 lg:pt-32 xl:pt-36 pb-20 sm:pb-24 md:pb-28 lg:pb-32 xl:pb-36 overflow-x-hidden relative"
    >
      <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6 sm:gap-8 lg:gap-10 xl:gap-12 items-start w-full">
        ...
        <div className="px-5 sm:px-6 md:px-8 lg:px-16 xl:px-24 lg:sticky lg:top-0 order-1 self-start pt-0">
          <motion.h2
            ...
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light text-white font-sans tracking-tight uppercase"
          >
            ABOUT
          </motion.h2>
        </div>
            ...
            <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-7">
              ...
              <div className="relative">
                <motion.h3
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-light text-white font-sans leading-[1.08] tracking-tight pr-4"
                >
              ...
              >
                <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl text-white/75 font-light font-sans leading-[1.6] tracking-wide">
              ...
              >
                <div className="relative bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-4 sm:p-5 md:p-6 hover:border-white/25 hover:bg-white/[0.05] transition-all duration-700 group overflow-hidden">
                  ...
                  <div className="relative space-y-3 sm:space-y-4">
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-xl text-white/85 font-light font-sans leading-[1.6]">
                    ...
                    <div className="space-y-2 sm:space-y-2.5 pl-3 sm:pl-5 border-l-2 border-white/25 group-hover:border-white/50 transition-colors duration-700">
                      <motion.p 
                        ...
                        className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl text-white font-light font-sans leading-[1.4]"
                      >
                        It needed clarity.
                      </motion.p>
                      <motion.p 
              ...
              >
                <div className="relative">
                  <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-white font-light leading-[1.3] tracking-[-0.015em] max-w-4xl" style={{ fontFamily: 'ui-serif, Georgia, "Times New Roman", Times, serif' }}>
