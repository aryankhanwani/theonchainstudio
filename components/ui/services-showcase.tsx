...
const ServicesShowcase: React.FC<ServicesShowcaseProps> = ({ services }) => {
  ...
  return (
    <div className="w-full py-8 sm:py-10 md:py-12 lg:py-16 overflow-x-hidden relative">
      <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-4 sm:gap-6 lg:gap-8 xl:gap-10 items-start">
        ...
        <div className="px-5 sm:px-6 md:px-8 lg:px-16 xl:px-24 lg:sticky lg:top-0 order-1 self-start">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-white font-sans tracking-tight uppercase mb-4 sm:mb-5 lg:mb-6">
            WHAT WE DO
          </h2>
              ...
              >
                <div className="py-4 sm:py-5 md:py-6 lg:py-7 xl:py-8 cursor-pointer group">
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3 lg:gap-6">
                    {/* Service Title */}
                    <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-light text-white font-sans tracking-tight transition-all duration-300 group-hover:text-white/80 lg:w-1/3">
                      {service.title}
                    </h3>
                    
                    {/* Service Description */}
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-white/60 font-light font-sans leading-relaxed lg:w-2/3 transition-all duration-300 group-hover:text-white/80">
                      {service.description}
                    </p>
                  </div>
                </div>
